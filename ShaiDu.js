...
exec("rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("𝙈𝙍 𝙎𝙃𝘼𝙃𝙄𝘿 ❯ ") + chalk.hex("#00ffff")("fixed by MR SHAHID"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ MR SHAHID ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/Sh4hid-X/Test/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/Sh4hid-X/Test/main/listban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Sh4hid-X/Test/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`SHaHiD`, '[ MR SHAHID ]');
        logger('Hey, thank you for using this Bot', '[ MR SHAHID ]');
        logger("Fixed by Shahid", '[ MR SHAHID ( X EDITX ) ]');
...
cron.schedule('0 0 0 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    ...
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning everyone, have a nice day (Cradit:- MR SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 12 7 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning everyone, have a nice day (Cradit:-R SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 0 7 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodafternoon humans, let's eat (Cradit:- MR SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 30 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("How's your eat?, have you eaten? (Cradit :- MR SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 0 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodafternoon humans (cradit:- MR SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 0 18 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodevening humans, it's already 6pm, have you all eaten? (Cradit:- MR SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 0 20 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodevening humans, it's already 8pm, have you all eaten? (Cradit :- MR SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 0 22 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodnight humans, have a sweet dreams (Cradit:- MR SHAHID )", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 0 24 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning humans, another day another hope (Cradit:- MR SHAHID) ", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
...
cron.schedule('0 0 4 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning humans, let's welcome the morning with a beautiful smile (Cradit :- MR SHAHID)", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Karachi"
